...
- **领域标签**：README, 项目文档, 上下文, agent 上下文, CLAUDE.md, AGENT.md, 项目概述, onboarding, 项目理解, 文档生成
- **能力概述**：售前工程师角色。负责维护项目 README.md 和生成 CLAUDE.md/AGENT.md 项目上下文文档，帮助其他角色快速理解项目全貌。支持从代码库中自动提取技术栈、目录结构、编码约定等信息。
- **使用方式**：用户显式调用 /RDD-PSE 触发；自动扫描项目生成/更新 README 和 Agent 上下文文件
