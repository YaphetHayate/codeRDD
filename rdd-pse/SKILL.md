...
3. **亮点呈现** — 发掘 3-5 条有证据的项目特色，场景化叙述（痛点→解法→证据）。售前的核心职责：识别并呈现卖点
4. **快速开始** — 安装依赖 → 配置 → 运行，三步以内能跑起来
5. **项目结构** — 关键目录和文件的作用
6. **使用方式** — 常用命令、入口说明
7. **技术栈** — 主要语言、框架、关键依赖
8. **贡献指南** — 如何参与开发（如有）
...
- 简洁直接，不过度美化
- 结构清晰，善用表格和代码块
- 避免无证据的形容词（"高性能""易扩展"），但鼓励有证据支撑的特色呈现——见 `references/readme-template.md` 的"亮点"章节
